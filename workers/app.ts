...
app.post("/api/signup", async (c) => {
  console.log("Received /api/signup request");
...
app.post("/api/todos", async (c) => {
  console.log("Received /api/todos POST request");
...
app.delete("/api/todos/:id", async (c) => {
  console.log("Received /api/todos DELETE request");
  const { DB, JWT_SECRET } = env<Bindings>(c);
...
app.get("/api/me", async (c) => {
  console.log("Received /api/me GET request");
  const { DB, JWT_SECRET } = env<Bindings>(c);
